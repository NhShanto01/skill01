  ...
  return (
    <div>
      <CardGroup className="">
        ...
        <Card>
          <Card.Img variant="top" className="img-size" src={days} />
          <Card.Body>
            <Card.Text>
        ...
        <Card>
          <Card.Img variant="top" className="img-size" src={happiness} />
          <Card.Body>
            <Card.Text>
              This is a wider card with supporting text below as a natural
              lead-in to additional content. This content is a little bit
        ...
        <Card>
          <Card.Img variant="top" className="img-size" src={design} />
          <Card.Body>
            <Card.Text>
              This is a wider card with supporting text below as a natural
              lead-in to additional content. This content is a little bit
        ...
        <Card>
          <Card.Img variant="top" className="img-size" src={years} />
          <Card.Body>
            <Card.Text>
              This is a wider card with supporting text below as a natural
              lead-in to additional content. This content is a little bit
